  ...
  return (
    <div className="w-full max-w-md p-8 bg-white font-sans shadow-lg rounded-lg">
      <div className="text-center mb-8">
        ...
        <p className="text-sm text-gray-600 mt-2">Save LinkedIn job applications directly to a Notion database with one click.</p>
      </div>
      ...
      <div className="mt-6 text-center">
        <p className="text-sm text-gray-600">
          ...
          <a href="https://www.notion.so/signup" target="_blank" rel="noopener noreferrer" className="text-blue-600 hover:underline">Sign up</a>
        </p>
      </div>
    </div>
  );
